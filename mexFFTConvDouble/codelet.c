...
{
	int i, j, theta;
	double alpha, beta, beta1, beta2, y0, y1, y2, y3;
	for (i = 0; i < 1024; i += 4)
	{
		alpha = A[i];
		beta = A[i + 1];
	...
	for (i = 0; i < 1024; i += 8)
	{
		...
		A[i + 6] = alpha - beta;
		alpha = A[i + 1];
		beta1 = 0.70710678118654752440084436210485*(A[i + 5] + A[i + 7]);
		beta2 = 0.70710678118654752440084436210485*(A[i + 5] - A[i + 7]);
		A[i + 1] = alpha + beta1;
		A[i + 5] = alpha - beta1;
		alpha = A[i + 3];
		A[i + 3] = alpha + beta2;
...
void DFT8(double *A, const double *sinTab)
{
	...
	A[2] = alpha + A[6];
	A[6] = alpha - A[6];
	beta1 = 0.70710678118654752440084436210485*(A[5] + A[7]);
	beta2 = 0.70710678118654752440084436210485*(A[5] - A[7]);
	A[5] = A[1] - beta1;
	A[1] = A[1] + beta1;
	A[7] = A[3] - beta2;
	A[3] = A[3] + beta2;
